...
namespace ININET
{
    ...
    /// </summary>
    public class ININETFileParser : ININETStreamParser
    {
        /// <summary>
        ///     Ctor
        /// </summary>
        public ININETFileParser() {}

        /// <summary>
        ///     Ctor
        /// </summary>
        /// <param name="parser"></param>
        public ININETFileParser(ININETStringParser parser) : base(parser)
        {
            Parser = parser;
        }
