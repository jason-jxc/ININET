...
namespace ININET.Model.Configuration
{
    ...
    public class IniParserConfiguration : ICloneable
    {
        ...
        /// <summary>
        ///     Default values used if an instance of <see cref="ININETStringParser"/>
        ...
        ///     the <see cref="ININETStringParser"/> will stop with an error.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="ININETStringParser"/> finds duplicate keys in a
        ...
        /// <summary>
        ///     If <c>true</c> the <see cref="ININETStringParser"/> instance will thrown an exception
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="ININETStringParser"/> finds a duplicate section
        ///     the parser will stop with an error.
        ///     If set to <c>true</c>, duplicated sections are allowed in the file, but only a
        ///     <see cref="SectionData"/> element will be created in the <see cref="ININETData.Sections"/>
        ///     collection.
        /// </summary>
        /// <remarks>
        ///     Defaults to <c>false</c>.
        ...
        /// <summary>
        ///     If set to <c>false</c>, the <see cref="ININETStringParser"/> stop with a error if you try
